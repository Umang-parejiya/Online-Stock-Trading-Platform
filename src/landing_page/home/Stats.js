    ...
    return (
       ...
       <div className='row '>
        ...
        <div className='col-6 mt-5'>
            <img src='media\ecosystem.png' alt='ecosystem' style={{width:"95%"}}></img>
            <div className='text-center'>
                <a href=''style={{textDecoration:"none" , margin:'5%'}}>Explore our products <i class="fa-solid fa-arrow-right"></i></a>
